...
(() => {
/*!********************************************!*\
  !*** ./src/blocks/star-rating/frontend.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (starRatingItems.length) {
    starRatingItems.forEach((item, index) => {
      ...
      root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_src_controls_star_rating__WEBPACK_IMPORTED_MODULE_1__["default"], {
        rating: ratingValue,
        total: 5
      }, index));
    });
