...
/***/ "./src/blocks/business-hour/attributes.js":
/*!************************************************!*\
  !*** ./src/blocks/business-hour/attributes.js ***!
  \************************************************/
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/blocks/business-hour/constants/index.js");
/* harmony import */ var _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constants/typoPrefixConstant */ "./src/blocks/business-hour/constants/typoPrefixConstant.js");
const {
...
const attributes = {
  ...
  ...generateResRangeAttributies(_constants__WEBPACK_IMPORTED_MODULE_0__.ITEM_GAP),
  ...generateNormalBGAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.BUSINESS_ITEM_BG),
  ...generateNormalBGAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.BUSINESS_ITEM_ODD_BG),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.BUSINESS_ITEM_RADIUS),
  ...generateBorderAttributies(_constants__WEBPACK_IMPORTED_MODULE_0__.BUSINESS_ITEM_BORDER),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.BUSINESS_ITEM_MARGIN),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.BUSINESS_ITEM_PADDING),
  // days
  ...generateNormalBGAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.DAYS_BG),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.DAYS_RADIUS),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.DAYS_PADDING),
  // closed days
  ...generateNormalBGAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.CLOSED_DAYS_BG),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.CLOSED_DAYS_RADIUS),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.CLOSED_DAYS_PADDING),
  //times

  ...generateNormalBGAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.TIMES_BG),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.TIMES_RADIUS),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.TIMES_PADDING),
  //Closed times
  ...generateNormalBGAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.CLOSED_TIMES_BG),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.CLOSED_TIMES_RADIUS),
  ...generateDimensionAttributes(_constants__WEBPACK_IMPORTED_MODULE_0__.CLOSED_TIMES_PADDING),
  //Typography
...
/***/ "./src/blocks/business-hour/constants/index.js":
/*!*****************************************************!*\
  !*** ./src/blocks/business-hour/constants/index.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   BUSINESS_ITEM_BG: () => (/* binding */ BUSINESS_ITEM_BG),
/* harmony export */   BUSINESS_ITEM_BORDER: () => (/* binding */ BUSINESS_ITEM_BORDER),
/* harmony export */   BUSINESS_ITEM_MARGIN: () => (/* binding */ BUSINESS_ITEM_MARGIN),
/* harmony export */   BUSINESS_ITEM_ODD_BG: () => (/* binding */ BUSINESS_ITEM_ODD_BG),
/* harmony export */   BUSINESS_ITEM_PADDING: () => (/* binding */ BUSINESS_ITEM_PADDING),
/* harmony export */   BUSINESS_ITEM_RADIUS: () => (/* binding */ BUSINESS_ITEM_RADIUS),
/* harmony export */   CLOSED_DAYS_BG: () => (/* binding */ CLOSED_DAYS_BG),
/* harmony export */   CLOSED_DAYS_PADDING: () => (/* binding */ CLOSED_DAYS_PADDING),
/* harmony export */   CLOSED_DAYS_RADIUS: () => (/* binding */ CLOSED_DAYS_RADIUS),
/* harmony export */   CLOSED_TIMES_BG: () => (/* binding */ CLOSED_TIMES_BG),
/* harmony export */   CLOSED_TIMES_PADDING: () => (/* binding */ CLOSED_TIMES_PADDING),
/* harmony export */   CLOSED_TIMES_RADIUS: () => (/* binding */ CLOSED_TIMES_RADIUS),
/* harmony export */   DAYS_BG: () => (/* binding */ DAYS_BG),
/* harmony export */   DAYS_OPTION: () => (/* binding */ DAYS_OPTION),
/* harmony export */   DAYS_PADDING: () => (/* binding */ DAYS_PADDING),
/* harmony export */   DAYS_RADIUS: () => (/* binding */ DAYS_RADIUS),
/* harmony export */   ITEM_GAP: () => (/* binding */ ITEM_GAP),
/* harmony export */   ITEM_OPTION: () => (/* binding */ ITEM_OPTION),
/* harmony export */   PANEL_OPTION: () => (/* binding */ PANEL_OPTION),
/* harmony export */   PRESETOPTION: () => (/* binding */ PRESETOPTION),
/* harmony export */   TIMES_BG: () => (/* binding */ TIMES_BG),
/* harmony export */   TIMES_PADDING: () => (/* binding */ TIMES_PADDING),
/* harmony export */   TIMES_RADIUS: () => (/* binding */ TIMES_RADIUS),
/* harmony export */   TIME_OPTION: () => (/* binding */ TIME_OPTION)
/* harmony export */ });
...
// Block Prefix
const BLOCK_PREFIX = 'businessHour';
const ITEM_GAP = 'itemGap';
//business item working Day
const BUSINESS_ITEM_BG = 'businessHourBG';
const BUSINESS_ITEM_ODD_BG = 'businessHourOddBg';
const BUSINESS_ITEM_RADIUS = 'businessItemRadius';
const BUSINESS_ITEM_BORDER = 'businessItemBorder';
const BUSINESS_ITEM_MARGIN = 'businessItemMargin';
const BUSINESS_ITEM_PADDING = 'businessItemPadding';

//Days
const DAYS_BG = 'daysBg';
const DAYS_RADIUS = 'daysRadius';
const DAYS_PADDING = 'daysPadding';
//closed day

const CLOSED_DAYS_BG = 'closedDayBg';
const CLOSED_DAYS_RADIUS = 'closedDayRadius';
const CLOSED_DAYS_PADDING = 'closedDayPadding';
//times
const TIMES_BG = 'timesBg';
const TIMES_RADIUS = 'timesRadius';
const TIMES_PADDING = 'timesPadding';

//closed time
const CLOSED_TIMES_BG = 'closedTimeBg';
const CLOSED_TIMES_RADIUS = 'closedTimeRadius';
const CLOSED_TIMES_PADDING = 'closedTimePadding';

//option preset

const PRESETOPTION = [{
  label: 'Preset 1',
  value: 'zolo-biz-hours-style-1'
}, {
  label: 'Preset 2',
  value: 'zolo-biz-hours-style-2'
}];
const PANEL_OPTION = [{
  label: 'Odd',
  value: 'normal'
...
/***/ "./src/blocks/business-hour/constants/typoPrefixConstant.js":
/*!******************************************************************!*\
  !*** ./src/blocks/business-hour/constants/typoPrefixConstant.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CLOSED_DAYS_TYPO: () => (/* binding */ CLOSED_DAYS_TYPO),
/* harmony export */   CLOSED_TIMES_TYPO: () => (/* binding */ CLOSED_TIMES_TYPO),
/* harmony export */   DAYS_TYPO: () => (/* binding */ DAYS_TYPO),
/* harmony export */   TIMES_TYPO: () => (/* binding */ TIMES_TYPO)
/* harmony export */ });
const DAYS_TYPO = 'DaysTypo';
const TIMES_TYPO = 'TimesTypo';
//CLOSED DAY
const CLOSED_DAYS_TYPO = 'closedDayTypo';

//Closed Times
const CLOSED_TIMES_TYPO = 'closedTimeTypo';

/***/ }),

/***/ "./src/blocks/business-hour/edit.js":
/*!******************************************!*\
  !*** ./src/blocks/business-hour/edit.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./inspector */ "./src/blocks/business-hour/inspector.js");
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style */ "./src/blocks/business-hour/style.js");
...
function Edit(props) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps)({
    className: classnames__WEBPACK_IMPORTED_MODULE_4___default()(className, uniqueId, preset, classArrayToStr(parentClasses))
  });
  ...
  if (preview) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("img", {
      ...
      alt: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('List Links Preview', 'zoloblocks')
    });
  }
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [isSelected && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_inspector__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      props: props
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.BlockControls, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      ...blockProps,
      children: [renderHookBefore && renderHookBefore, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(SidebarOpener, {
        clientId: clientId
      }), businessList && businessList.map((profile, index) => {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
          className: profile.toggleworkday ? 'zolo-biz-hours-item zolo-current-date' : 'zolo-biz-hours-item-closed  zolo-hour-closed',
          children: [profile.toggleworkday ? profile.name && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
            className: "zolo-biz-day",
            children: profile.name
          }) : profile.name && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
            className: "zolo-biz-day-closed",
            children: profile.name
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            className: "zolo-biz-time-wrap",
            children: profile.toggleworkday ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
              children: [profile.startDate && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
                className: "zolo-biz-time",
                children: profile.startDate
              }), profile.startDate && profile.endDate && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
                className: "zolo-biz-time-separator",
                children: "-"
              }), profile.endDate && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
                className: "zolo-biz-time",
                children: profile.endDate
              })]
            }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("span", {
              className: "zolo-business-closed-time",
              children: profile.closedDay
            })
          })]
        }, index);
...
/***/ "./src/blocks/business-hour/index.js":
/*!*******************************************!*\
  !*** ./src/blocks/business-hour/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _attributes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./attributes */ "./src/blocks/business-hour/attributes.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/business-hour/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/blocks/business-hour/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./src/blocks/business-hour/save.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/business-hour/style.scss");
...
/***/ "./src/blocks/business-hour/inspector.js":
/*!***********************************************!*\
  !*** ./src/blocks/business-hour/inspector.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _sortable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sortable */ "./src/blocks/business-hour/sortable.js");
...
/* harmony import */ var _attributes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./attributes */ "./src/blocks/business-hour/attributes.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./constants */ "./src/blocks/business-hour/constants/index.js");
...
/* harmony import */ var _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./constants/typoPrefixConstant */ "./src/blocks/business-hour/constants/typoPrefixConstant.js");
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(HeaderTabs, {
      ...
      generalTab: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ZoloPanelBody, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Preset', 'zoloblocks'),
            value: preset,
            options: _constants__WEBPACK_IMPORTED_MODULE_5__.PRESETOPTION,
            onChange: v => {
              setAttributes({
                preset: v
              });
          ...
          title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Business List', 'zoloblocks'),
          panelProps: props,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_sortable__WEBPACK_IMPORTED_MODULE_0__["default"], {
      ...
      styleTab: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(ZoloPanelBody, {
          ...
          stylePanel: true,
          panelProps: props,
          children: [preset == 'zolo-biz-hours-style-1' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(NormalBGControl, {
            requiredProps: requiredProps,
            controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.BUSINESS_ITEM_BG,
            noOverlay: false,
            noMainBGImg: false
            ...
            controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.BUSINESS_ITEM_MARGIN,
            requiredProps: requiredProps,
            forBorderRadius: false
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Padding', 'zoloblocks'),
            controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.BUSINESS_ITEM_PADDING,
            requiredProps: requiredProps,
            forBorderRadius: false
            ...
            controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.BUSINESS_ITEM_BORDER,
            requiredProps: requiredProps
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Border Radius', 'zoloblocks'),
            controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.BUSINESS_ITEM_RADIUS,
            requiredProps: requiredProps,
            forBorderRadius: true
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResRangeControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Gap', 'zoloblocks'),
            controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.ITEM_GAP,
            requiredProps: requiredProps
          }), preset === 'zolo-biz-hours-style-2' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(TabPanelControl, {
            options: _constants__WEBPACK_IMPORTED_MODULE_5__.PANEL_OPTION,
            normalComponents: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(NormalBGControl, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Background', 'zoloblocks'),
              requiredProps: requiredProps,
              controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.BUSINESS_ITEM_ODD_BG,
              noOverlay: false,
              noMainBGImg: false
            }),
            hoverComponents: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(NormalBGControl, {
              requiredProps: requiredProps,
              controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.BUSINESS_ITEM_BG,
              noOverlay: false,
              noMainBGImg: false
          ...
          title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Days', 'zoloblocks'),
          stylePanel: true,
          panelProps: props,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(TabPanelControl, {
            options: _constants__WEBPACK_IMPORTED_MODULE_5__.DAYS_OPTION,
            normalComponents: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ColorControl, {
                ...
                typoPrefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_7__.DAYS_TYPO,
                requiredProps: requiredProps,
                max: 36
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(NormalBGControl, {
                requiredProps: requiredProps,
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.DAYS_BG,
                noOverlay: false,
                noMainBGImg: true
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Padding', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.DAYS_PADDING,
                requiredProps: requiredProps,
                forBorderRadius: false
                ...
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Border Radius', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.DAYS_RADIUS,
                requiredProps: requiredProps,
                forBorderRadius: true
              })]
            }),
            hoverComponents: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ColorControl, {
                ...
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Typography', 'zoloblocks'),
                typoPrefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_7__.CLOSED_DAYS_TYPO,
                requiredProps: requiredProps,
                max: 36
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(NormalBGControl, {
                requiredProps: requiredProps,
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.CLOSED_DAYS_BG,
                noOverlay: false,
                noMainBGImg: true
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Padding', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.CLOSED_DAYS_PADDING,
                requiredProps: requiredProps,
                forBorderRadius: false
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Border Radius', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.CLOSED_DAYS_RADIUS,
                requiredProps: requiredProps,
                forBorderRadius: true
              })]
            })
          ...
          title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Times', 'zoloblocks'),
          stylePanel: true,
          panelProps: props,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(TabPanelControl, {
            normalComponents: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ColorControl, {
                ...
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Separator Color', 'zoloblocks'),
                color: separatColor,
                onChange: value => setAttributes({
                  separatColor: value
                })
                ...
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Typography', 'zoloblocks'),
                typoPrefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_7__.TIMES_TYPO,
                requiredProps: requiredProps,
                max: 36
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(NormalBGControl, {
                requiredProps: requiredProps,
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.TIMES_BG,
                noOverlay: false,
                noMainBGImg: true
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Padding', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.TIMES_PADDING,
                requiredProps: requiredProps,
                forBorderRadius: false
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Border Radius', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.TIMES_RADIUS,
                requiredProps: requiredProps,
                forBorderRadius: true
              })]
            }),
            hoverComponents: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ColorControl, {
                ...
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Typography', 'zoloblocks'),
                typoPrefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_7__.CLOSED_TIMES_TYPO,
                requiredProps: requiredProps,
                max: 36
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(NormalBGControl, {
                requiredProps: requiredProps,
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.CLOSED_TIMES_BG,
                noOverlay: false,
                noMainBGImg: true
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Padding', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.CLOSED_TIMES_PADDING,
                requiredProps: requiredProps,
                forBorderRadius: false
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(ResDimensionsControl, {
                label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Border Radius', 'zoloblocks'),
                controlName: _constants__WEBPACK_IMPORTED_MODULE_5__.CLOSED_TIMES_RADIUS,
                requiredProps: requiredProps,
                forBorderRadius: true
              })]
            }),
            options: _constants__WEBPACK_IMPORTED_MODULE_5__.TIME_OPTION
          })
        })]
      }),
...
/***/ "./src/blocks/business-hour/save.js":
/*!******************************************!*\
  !*** ./src/blocks/business-hour/save.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Save = props => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
    ..._wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save({
      className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(uniqueId, preset, classArrayToStr(parentClasses))
    }),
    ...(zoloId && {
      id: zoloId
    }),
    children: [renderHookBefore && renderHookBefore, businessList && businessList.map((profile, index) => {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
        className: profile.toggleworkday ? 'zolo-biz-hours-item zolo-current-date' : 'zolo-biz-hours-item-closed  zolo-hour-closed',
        children: [profile.toggleworkday ? profile.name && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
          className: "zolo-biz-day",
          children: profile.name
        }) : profile.name && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
          className: "zolo-biz-day-closed",
          children: profile.name
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
          className: "zolo-biz-time-wrap",
          children: profile.toggleworkday ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
            children: [profile.startDate && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
              className: "zolo-biz-time",
              children: profile.startDate
            }), profile.startDate && profile.endDate && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
              className: "zolo-biz-time-separator",
              children: "-"
            }), profile.endDate && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
              className: "zolo-biz-time",
              children: profile.endDate
            })]
...
/***/ "./src/blocks/business-hour/sortable.js":
/*!**********************************************!*\
  !*** ./src/blocks/business-hour/sortable.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Sortable = ({
  ...
  const deepCloneProfiles = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.cloneDeep)(businessList);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
        ...
        children: __('Add Business Day', 'zoloblocks')
      ...
      defaultItems: businessList,
      attributeName: "businessList",
      setAttributes: setAttributes,
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(Button, {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(PanelBody, {
              ...
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.CardDivider, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(ToggleControl, {
              ...
              }), profile.toggleworkday ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.Fragment, {
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(TextControl, {
...
/***/ "./src/blocks/business-hour/style.js":
/*!*******************************************!*\
  !*** ./src/blocks/business-hour/style.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constants */ "./src/blocks/business-hour/constants/index.js");
/* harmony import */ var _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constants/typoPrefixConstant */ "./src/blocks/business-hour/constants/typoPrefixConstant.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__);
/**
 * WordPress dependencies
...
const Style = ({
  ...
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.BUSINESS_ITEM_BG,
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.BUSINESS_ITEM_ODD_BG,
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.BUSINESS_ITEM_RADIUS,
  ...
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.BUSINESS_ITEM_BORDER,
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.BUSINESS_ITEM_MARGIN,
    styleFor: 'margin',
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.BUSINESS_ITEM_PADDING,
    styleFor: 'padding',
    attributes
  });
  ...
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.DAYS_BG,
    attributes
  });
  const {
    ...
    prefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_2__.DAYS_TYPO,
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.DAYS_RADIUS,
    styleFor: 'border-radius',
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.DAYS_PADDING,
    styleFor: 'padding',
    attributes
  });
  ...
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.CLOSED_DAYS_BG,
    attributes
  });
  const {
    ...
    prefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_2__.CLOSED_DAYS_TYPO,
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.CLOSED_DAYS_RADIUS,
    styleFor: 'border-radius',
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.CLOSED_DAYS_PADDING,
    styleFor: 'padding',
    attributes
  });
  ...
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.TIMES_BG,
    attributes
  });
  const {
    ...
    prefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_2__.TIMES_TYPO,
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.TIMES_RADIUS,
    styleFor: 'border-radius',
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.TIMES_PADDING,
    styleFor: 'padding',
    attributes
  });
  ...
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.CLOSED_TIMES_BG,
    attributes
  });
  const {
    ...
    prefixConstant: _constants_typoPrefixConstant__WEBPACK_IMPORTED_MODULE_2__.CLOSED_TIMES_TYPO,
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.CLOSED_TIMES_RADIUS,
    styleFor: 'border-radius',
    attributes
  });
  const {
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_1__.CLOSED_TIMES_PADDING,
    styleFor: 'padding',
    attributes
  });
...
/***/ "./src/blocks/business-hour/style.scss":
/*!*********************************************!*\
  !*** ./src/blocks/business-hour/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/business-hour/block.json":
/*!*********************************************!*\
  !*** ./src/blocks/business-hour/block.json ***!
  \*********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","title":"Business Hours","name":"zolo/business-hour","category":"zoloblocks","keywords":["business","hour","time","schedule","opening","closing"],"description":"Display business hours with visually customizable options.","apiVersion":3,"textdomain":"zoloblocks","example":{"attributes":{"preview":true},"viewportWidth":410},"supports":{"anchor":false,"customClassName":false,"align":["wide","full"]},"editorScript":"file:./index.js","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/business-hour/index": 0,
/******/ 			"blocks/business-hour/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/business-hour/style-index"], () => (__webpack_require__("./src/blocks/business-hour/index.js")))
