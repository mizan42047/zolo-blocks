...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (animatedCounters.length > 0) {
    animatedCounters.forEach(counter => {
      const root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(counter);
      root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(react_countup__WEBPACK_IMPORTED_MODULE_1__["default"], {
        end: counter.dataset.count || '1000',
        duration: 3.2
      }));
    });
  }
